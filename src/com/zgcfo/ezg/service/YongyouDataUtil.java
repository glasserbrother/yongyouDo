...
public class YongyouDataUtil {
	 ...
	 * 
	 * */
	public void beginInsert(String accountBookId,Integer yongyouBookId,String period){
	...
	private void saveSubject(Subject sbj, YongYouService yongyouService, Integer yongyouBookId, String period) {
		...
		//保存明细账
		List<Object> detailAccounts = yongyouService.getDetailAccountReport(yongyouBookId, period, period, sbj.getYongyouId()+"");
