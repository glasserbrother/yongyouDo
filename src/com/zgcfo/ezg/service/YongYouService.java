...
public class YongYouService {
	...
	public final static String SERVICEURL =  "http://ee.chanjet.com";
	...
	public final static String REQUESTURL = "http://ee.uu.com.cn";
	...
	public boolean initService(String loginName,String password){
		boolean flag = false;
		Map<String, Object> token =  this.getCiaToken(loginName,MD5.getInstance().getMD5( password).toLowerCase());
		if(token != null &&  Integer.valueOf(token.get("code")+"") == 200){
			flag = true;
	 ...
	 * **/
	public Map<String,Object> getCiaToken(String loginName,String password){
	...
	public Map<String,Object> getDataByPost(String url,Class entityClass){
		return getDataByPost(null,url,entityClass);
	}
	
	public Map<String,Object> getDataByPost(Map<String,Object> paramsMap,String url,Class entityClass){
		return getData(paramsMap,url,entityClass,"post");
	}
	
	public Map<String,Object> getDataByGet(String url,Class entityClass){
		return getDataByGet(null,url,entityClass);
	}
	
	public Map<String,Object> getDataByGet(Map<String,Object> paramsMap,String url,Class entityClass){
	...
	public Map<String,Object> getData(Map<String,Object> paramsMap,String url,Class entityClass,String method){
		Map<String,Object> resultMap = null;
		try{
			resultMap = new HashMap<String,Object>();
			String result = "";
	...
	public Map<String,Object> getIncomeReport2(Integer bookId,String period){
		String param = "";
		try {
	...
	public Map<String,Object> getBlanaceReport(Integer bookId,String period){
		String param = "";
		try {
	...
	public Map<String, Object> getTaxReport(int bookId, String period) {
	...
	public List<Object> getTaxReports(int bookId, String period) {
		...
		if(resultMap != null && Integer.valueOf(resultMap.get("code")+"") == 200)
	...
	public List<Object> getReport(String param, Class class1){
	 ...
	 * 
	 * */
	public List<Object> getReport(String param,Class clazz,String url){
	 ...
	 * @return 返回List<Object> Object 可直接强制转换为BalanceReport 如返回null则接口异常
 	 * **/
	public List<Object> getBalanceReport(Integer bookId,String period){
	 ...
	 * @return 返回List<Object> Object 可直接强制转换为CashReport 如返回null则接口异常
 	 * **/
	public List<Object> getCashReport(Integer bookId,String period){
	 ...
	 * */
	public List<Object> getBalance(Integer bookId,String startPeriod,String endPeriod){
	 ...
	 * 
	 * */
	public List<Object> getBalance(Integer bookId,String startPeriod,String endPeriod,Integer balanceType){
	 ...
	 * @return 返回List<Object> Object 可直接强制转换为IncomeReport 如返回null则接口异常
 	 * **/
	public List<Object> getIncomeReport(Integer bookId,String period){
	...
	public List<Object> getIncomeQuarterReport(Integer bookId,String period){
	...
	public List<Object> getSubjects(Integer bookId){
	...
	public List<Object> getDetailAccountReport(Integer bookId,String startPeriod,String endPeriod,String subjectId){
	 ...
	 * 
	 * **/
	public Map<String,Object> getKeyIndex(String accountBookId,String period){
	 ...
	 * 
	 * **/
	public Map<String,Object> getKeyIndex(Integer bookId, String period){
		Map<String,Object> keyIndexMap = null;	
		try{
			keyIndexMap = new HashMap<String,Object>();	
	...
	public static void main(String[] args) throws UnsupportedEncodingException, URISyntaxException, NumberFormatException, ClassNotFoundException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		...
		List<Object> obj = yongYou.getIncomeReport(100014, "201610");
		System.out.println(JSON.toJSONString(obj));
		List<Object> obj2 = yongYou.getBalanceReport(100014, "201610");
		System.out.println(JSON.toJSONString(obj2));
		List<Object> obj3 = yongYou.getCashReport(100014, "201610");
		System.out.println(JSON.toJSONString(obj3));
		List<Object> map2 = yongYou.getIncomeQuarterReport(100014, "201610");
